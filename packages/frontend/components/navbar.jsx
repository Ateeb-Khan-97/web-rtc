    ...
    <>
      ...
      <nav className="sticky top-0 z-40 w-full text-white bg-gray-800">
        <div className="container h-full px-4 mx-auto">
          <div className="relative flex items-center h-full md:justify-between">
            <button
              type="button"
            ...
            <div className="flex items-center h-full hover:bg-gray-700 hover:text-white">
              <h1 className="flex items-center flex-shrink-0 px-2 text-xl font-bold text-white text-gray-300 hover:bg-gray-700 hover:text-white">
                <a href="/" className="h-full">
                  <img src="/57x57-no-bg.png" width={30} alt="" className="inline mr-3" />
                  {text.appName}
                </a>
              </h1>
            </div>
            ...
            >
              <div
                className={classNames({
                  "flex items-center w-full h-full text-gray-300 bg-transparent hover:bg-gray-700 hover:text-white md:w-auto": true,
                  "bg-gray-700 text-white": router.pathname === "/",
                })}
              >
                <Link href="/" passHref>
                  <a
              ...
              <div
                className={classNames({
                  "flex items-center w-full h-full text-gray-300 bg-transparent hover:bg-gray-700 hover:text-white md:w-auto": true,
                  "bg-gray-700 text-white": router.pathname === "/meeting",
                })}
              >
